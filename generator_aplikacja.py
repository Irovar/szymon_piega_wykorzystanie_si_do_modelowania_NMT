...
class DrawingApp:
    ...
    def setup_gui(self):
        ...
        tk.Button(button_frame, text="Rysuj Czerwonym (Wyżyny/Szczyty)", command=lambda: self.set_color("red")).pack(fill=tk.X, pady=5)
        tk.Button(button_frame, text="Rysuj Niebieskim (Niziny/Rzeki)", command=lambda: self.set_color("blue")).pack(fill=tk.X, pady=5)
